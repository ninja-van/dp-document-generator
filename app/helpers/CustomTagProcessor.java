...
public class CustomTagProcessor extends com.itextpdf.tool.xml.html.Image {
                ...
                if (!base64Data.isEmpty()) {
                    ...
                    if (img != null) {
                        try {
                            ...
                            elements.add(getCssAppliers().apply(new Chunk((Image) getCssAppliers().apply(img, tag, htmlPipelineContext), 0, 0, true)
